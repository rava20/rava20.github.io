...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $sql = mysqli_query($koneksi, "SELECT * FROM data_pendaftar WHERE nama LIKE '%$search%' OR nim LIKE '%$search%'");
    $daftar = [];
...
<div class="container">
      ...
      <form action="" method="GET" class="search-bar-mahasiswa">
        ...
        <button type="submit" value="cari" class="search-button-mahasiswa" >
          cari
        </button>
      </form>
    </search>
